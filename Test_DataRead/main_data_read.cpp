...
int main(int argc, char* argv[])
{
	...
	int in_h = 256;
	int in_c = 12;
	const char * dataPath = "c:/Users/pc/Documents/Visual Studio 2013/Projects/DopplerTrainPreProcess/IQApp_cuda/bin/x64/Debug/trainData/das9/das_301_01.dat";
	//const char * dataPath = "c:/Users/pc/Documents/Visual Studio 2013/Projects/DopplerTrainPreProcess/IQApp_cuda/bin/x64/Debug/trainData/in3CH_float/feature_00_042.dat";
	int input_len = in_c * in_w * in_h;
	...
	for (int i = 0; i < in_w*in_h; i++)
	{
		float normal = ( abs(input[offset+i]) / max_v) * 255;
		if (normal < 0) normal = 0;
		if (normal > 1) normal = 1;
		mask[i] = normal * 255;
	}
	printf("sum %f \n", sum);
	SaveImageFile("input1.bmp", mask, in_w, in_h);
